...
const FAQ = () => {
  ...
  return (
    <section className="bg-white mb-5">
      {/* Контейнер с боковыми паддингами 32px */}
              ...
              <div key={index} className="flex flex-col">
                  ...
                  <span className="w-5 h-5 mt-1 mr-4 shrink-0 flex items-center justify-center">
                    {openIndex === index ? (
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <path d="M13 1L1 13M1 1L13 13" stroke="black" strokeWidth="2" strokeLinecap="round"/>
                      </svg>
                    ) : (
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                ...
                >
                  <div className="overflow-hidden">
                    <span className="block pl-9 text-[14px] md:text-[15px] text-gray-800 leading-relaxed w-full">
                      {item.answer}
                    </span>
                  </div>
                </div>
